...
buttons.run = new Button(txt.IN_BT_RUN, {cls:'btn btn-primary', id:IN_BT_RUN})
divs.col1.addChild(elts.intro, elts.intro1, elts.list1, elts.hr, elts.intro2, buttons.run, elts.hr)

divs.col2 = new Div('col')
imgs.one = new Img('./static/resources/img/titrator.jpg', {cls:'image-fluid rounded', w:'100%'}).setStyle('max-height:300px')
