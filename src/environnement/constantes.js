...
export {
    ...
    ETAT_DOSAGE,
    ETAT_THEORIQUE,
    ETAT_PERPENDICULAIRE,
    K,
    ERR_DOSAGE_IMPOSSIBLE,
    ETAT_GRAPH_SAVE,
    TYPE_ES_MONOACIDEFAIBLE,
    TYPE_ES_MONOACIDEFORT,
    TYPE_ES_MONOBASEFAIBLE,
    TYPE_ES_MONOBASEFORTE,
    TYPE_ES_POLYACIDEFAIBLE,
    TYPE_ES_POLYACIDEFORT,
    TYPE_ES_POLYBASEFORTE,
    TYPE_ES_POLYBASEFAIBLE,
    CONC_EMAX,
    CONC_EMIN,
    CONC_MAX,
    CONC_MIN,
