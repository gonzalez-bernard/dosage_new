...
//sessionStorage.setItem("dosage",JSON.stringify(dosage))
...
export {
    ...
    ETAT_GRAPH_CD, ETAT_DERIVEE, ETAT_TANGENTE_1, ETAT_TANGENTE_2, COLOR_INIT, INDIC_PHI, INDIC_BBT, INDIC_RP, INDIC_H, INDIC_VB, INDIC_NET, ETAT_GRAPH_DSP, TYPE_NUL, ETAT_INITIAL, ETAT_MOVE_TANGENTE, ETAT_DOSAGE, ETAT_THEORIQUE, ETAT_PERPENDICULAIRE, K, ERR_DOSAGE_IMPOSSIBLE, ETAT_GRAPH_SAVE, TYPE_ES_MONOACIDEFAIBLE, TYPE_ES_MONOACIDEFORT, TYPE_ES_MONOBASEFAIBLE, TYPE_ES_MONOBASEFORTE, TYPE_ES_POLYACIDEFAIBLE, TYPE_ES_POLYACIDEFORT, TYPE_ES_POLYBASEFORTE, TYPE_ES_POLYBASEFAIBLE, CONC_EMAX, CONC_EMIN, CONC_MAX, CONC_MIN, CONC_RMAX, CONC_RMIN, VOL_MAX, VOL_MIN, VOL_RMAX, VOL_RMIN,
    BLANC, BLEU, BLEU_PALE, INCOLORE, JAUNE, ROUGE, VERT_PALE, VIOLET, JAUNE_PALE, COLORS, ETAT_POT, ETAT_GRAPH_PT, VOL_EMIN, VOL_EMAX, FILE_ZOOM_IN, FILE_ZOOM_OUT, ETAT_PROBLEM, FILE_BACKGROUND_LABO, GR_OPTIONS_PH, GR_OTHER_PT, GR_OTHER_CD, GR_OPTIONS_CD, GR_OTHER_PH, GR_OPTIONS_PT
};