...
divs.buttons_col = new Div('col-md-6', 'buttons_col').setStyle("width:530px; max-width:530px").addChild(buttons.reset, buttons.new_dosage, buttons.info)
...
divs.buttons_cont = new Div("col-md-6").addChild(divs.buttons_row)
...
// canvas graphe
elts.chart = new Element('div', { class: 'canvas', id: ui.DOS_CHART }).setStyle("width: 603px; height:603px; display:block; box-sizing:border-box")

// contient le canvas
divs.graph = new Div('row').addChild(elts.chart).setID(ui.DOS_GRAPHE).setStyle("min-width:600px; max-width:80%; position: relative; height: 65vh; width: 45vw")
