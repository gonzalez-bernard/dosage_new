...
info2.push("<p>Au dela du point d'équivalence, la concentration de l'ion permanganate n'est plus nulle, il apparaît alors la couleur violette caractéristique de ce dernier. La quantité de matière en permanganate est donnée par la relation :</p><b>$$ {n(NO_3^-) = \\frac{n_i(Fe^{2+}) - 5[MnO_4^-]_i \\times V_{eq}}{3}} $$</b>" +
"La concentration en nitrate se calcule ainsi :$$ {[NO_3^-] = \\frac{[Fe^{2+}]_i \\times V_i(Fe^{2+}) -5 [MnO_4^-] \\times V_{eq}}{3 \\times V_i(NO_3^-)}} $$")
