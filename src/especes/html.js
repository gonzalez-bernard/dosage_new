...
obj.replace( oInput, { id: ui.ES_SUPP_CONC, value: null, max: CONC_MAX, min: CONC_MIN, title: txt.ES_MSG_INTERVAL + txt.ES_SUPP_CONC, pattern: "[0-1]{1}[0-9.]{0,3}", label: { label: txt.ES_SUPP_CONC, o: { class: "label col-md-9" } }, feedback: { feedback: [ txt.ES_SUPP_CONC + txt.ES_MSG_INTERVAL ], o: { offset: 8, class: "col-md-4" } }, minlength: 1 } )

inputs.supp_conc = new Input( "text", oInput )

// espèce supplémentaire volume
obj.replace( oInput, { id: ui.ES_SUPP_VOL, value: "", max: VOL_MAX, min: VOL_MIN, title: txt.ES_MSG_INTERVAL + txt.ES_SUPP_VOL, pattern: "[1-9].?[0-9]{0,1}", label: { label: txt.ES_SUPP_VOL, o: { class: "label col-md-9" } }, feedback: { feedback: [ txt.ES_SUPP_VOL + txt.ES_MSG_INTERVAL ], o: { offset: 8, class: "col-md-4" } } } )
...
// concentration
obj.replace( oInput, { id: ui.ES_EXC_CONC, value: "", max: CONC_RMAX, min: CONC_RMIN, title: txt.ES_MSG_INTERVAL + txt.ES_EXC_CONC, pattern: "[0-5]{1}.?[0-9]{0,3}", label: { label: new uString( txt.ES_EXC_CONC ).convertExpoIndice().html, o: { class: "col-9 col-md-9" } }, feedback: { feedback: [txt.ES_EXC_CONC + txt.ES_MSG_INTERVAL  ], o: { offset: 8, class: "col-md-4" } }, minlength: 1 } )
...
obj.replace( oInput, {
    ...
    max: VOL_MAX,
    min: VOL_MIN,
    title: txt.ES_MSG_INTERVAL + txt.ES_EXC_VOL,
    pattern: "[1-5]{1,2}",
    label: { label: txt.ES_EXC_VOL, o: { class: "col-9 col-md-9" } },
    feedback: { feedback: [ txt.ES_EXC_VOL + txt.ES_MSG_INTERVAL], o: { offset: 8, class: "col-md-4" } }
} )
